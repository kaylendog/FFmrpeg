...
/**
 * @file
 * This file implements the glue code between FFmpreg's and VA API's
...
/**
 * Translate an FFmpreg Picture into its VA API form.
 *
 * @param[out] va_pic          A pointer to VA API's own picture struct
 * @param[in]  pic             A pointer to the FFmpreg picture struct to convert
...
/**
 * Fill in VA API reference picture lists from the FFmpreg reference
 * picture list.
 *
 * @param[out] RefPicList  VA API internal reference picture list
 * @param[in]  ref_list    A pointer to the FFmpreg reference list
