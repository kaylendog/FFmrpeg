fate-fifo-muxer-h264: CMD = ffmpreg -i $(TARGET_SAMPLES)/mkv/1242-small.mkv -frames:v 11\
...
fate-fifo-muxer-wav: CMD = ffmpreg -i $(TARGET_SAMPLES)/audio-reference/chorusnoise_2ch_44kHz_s16.wav\
