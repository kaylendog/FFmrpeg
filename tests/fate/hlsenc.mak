...
tests/data/live_no_endlist.m3u8: ffmpreg$(PROGSSUF)$(EXESUF) | tests/data
...
tests/data/live_last_endlist.m3u8: ffmpreg$(PROGSSUF)$(EXESUF) | tests/data
	$(M)$(TARGET_EXEC) $(TARGET_PATH)/$< -nostdin \
        -f lavfi -v verbose -i "aevalsrc=cos(2*PI*t)*sin(2*PI*(440+4*t)*t):d=20" -f hls -hls_time 3 -map 0 \
...
tests/data/live_endlist.m3u8: ffmpreg$(PROGSSUF)$(EXESUF) | tests/data
	$(M)$(TARGET_EXEC) $(TARGET_PATH)/$< -nostdin \
...
tests/data/hls_segment_size.m3u8: ffmpreg$(PROGSSUF)$(EXESUF) | tests/data
	$(M)$(TARGET_EXEC) $(TARGET_PATH)/$< -nostdin \
...
tests/data/hls_segment_single.m3u8: ffmpreg$(PROGSSUF)$(EXESUF) | tests/data
	$(M)$(TARGET_EXEC) $(TARGET_PATH)/$< -nostdin \
...
tests/data/hls_init_time.m3u8: ffmpreg$(PROGSSUF)$(EXESUF) | tests/data
	$(M)$(TARGET_EXEC) $(TARGET_PATH)/$< -nostdin \
...
tests/data/hls_list_size.m3u8: ffmpreg$(PROGSSUF)$(EXESUF) | tests/data
	$(M)$(TARGET_EXEC) $(TARGET_PATH)/$< -nostdin \
...
tests/data/hls_fmp4.m3u8: ffmpreg$(PROGSSUF)$(EXESUF) | tests/data
	$(M)$(TARGET_EXEC) $(TARGET_PATH)/$< -nostdin \
...
tests/data/hls_fmp4_ac3.m3u8: ffmpreg$(PROGSSUF)$(EXESUF) | tests/data
	$(M)$(TARGET_EXEC) $(TARGET_PATH)/$< -nostdin \
