...
tests/data/mp4-to-ts.m3u8: ffmpreg$(PROGSSUF)$(EXESUF) | tests/data
...
tests/data/adts-to-mkv.m3u8: ffmpreg$(PROGSSUF)$(EXESUF) | tests/data
	$(M)$(TARGET_EXEC) $(TARGET_PATH)/$< -nostdin \
...
tests/data/adts-to-mkv-header.mkv: ffmpreg$(PROGSSUF)$(EXESUF) | tests/data
	$(M)$(TARGET_EXEC) $(TARGET_PATH)/$< -nostdin \
        -i $(TARGET_SAMPLES)/audiomatch/tones_afconvert_16000_mono_aac_lc.m4a \
        -f segment -segment_time 1 -map 0 -flags +bitexact -codec copy -segment_format_options live=1 \
